export const aboutMarkdown = `# Intro
 ...
 I am a Physics undergraduate (avg. 29.8/30) at the [University of Milan](https://www.unimi.it/en) with research experience spanning dark matter detection (DarkSide, LZ, XENON) and biomechanics data analysis. My technical focus is on applying machine learning to physics research.
 
 Beyond academia, I have developed AI-driven systems in industry—ranging from enterprise chatbots to automated financial decision tools—while contributing to peer-reviewed publications and international hackathons. Deeply motivated by the intersection of Physics and AI, my ambition is to pursue a PhD directly after my bachelor’s.
 
 # Some History
 
 - **2018 - 2023**: Attended **Liceo Scientifico Alessandro Volta** in Milan, the top-ranked science high school in Italy.
 - **2023 - Present**: Started my B.Sc. in Physics at the **University of Milan**. Maintaining a 29.8/30 average, on track for early graduation.
 ...
 - **2025 (Sep)**: Won **1st Place** at **IBM Qiskit Fall Fest 2025** (Quantum Hackathon) at University of Milan.
 - **2025 (Sep - Dec)**: Exchange student at the **University of Oslo**, focusing on Quantum Reinforcement Learning for my Bachelor's Thesis.
 
 # I Like
 
 - Physics & AI (obviously)
 - Windsurfing (Instructor for 4 seasons)
 - Skiing
 - Alpinism
 - Music: Drums & Guitar
 - [GitHub](https://github.com/FrancescoMinisini)
